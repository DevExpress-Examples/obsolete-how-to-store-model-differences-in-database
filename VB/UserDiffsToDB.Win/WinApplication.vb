...
Namespace UserDiffsToDB.Win
	Partial Public Class UserDiffsToDBWindowsFormsApplication
		...
		Private Sub UserDiffsToDBWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
