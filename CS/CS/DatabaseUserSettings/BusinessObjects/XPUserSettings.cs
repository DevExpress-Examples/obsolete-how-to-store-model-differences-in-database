...
namespace DatabaseUserSettings.BusinessObjects {
    ...
    [ModelDefault("Caption", "User Settings")]
    public class XPUserSettings : XPObject, IDatabaseUserSettings {
        ...
        public string UserName {
            get {
                ...
                else if (string.IsNullOrEmpty(userNameCore)) {
                    userNameCore = Convert.ToString(Session.Evaluate(
                        DatabaseUserSettingsModule.UserTypeInfo.Type,
                        new OperandProperty(DatabaseUserSettingsModule.UserNameProperty),
                        new OperandProperty(DatabaseUserSettingsModule.UserTypeInfo.KeyMember.Name) == new OperandValue(DatabaseUserSettingsModule.UserIdTypeConverter.ConvertFromInvariantString(UserId)))
                    );
                }
                return userNameCore;
            }
